...
const ARENA_BASE = {
  ...
  // 수호석: 원형 벽(R+1.2=41.2) "바깥" 모래밭에 세운다 — 경기장 구조물에 안 겹쳐
  //  하트 개수가 한눈에 읽히고, 장 내 충돌·동선에도 영향이 없다(공격 불가·순수 연출물).
  //  주변에 팀의 토너먼트 포인트만큼 하트가 떠 있고, 라운드 패배 시 차감분만큼 펑펑 터진다.
  //  거리 계산: 벽 바깥끝 41.2+3(WALL_RADIUS)=44.2 + 수호석 시각 반경 7.9(받침+글로우 링) + 여유 2 ≈ 54
  NEXUS_POS: { blue: { x: -54, z: 0 }, red: { x: 54, z: 0 } },
  LANES: {
  ...
  WALL_LINES: [
    ...
    { x1: -12, z1: -16, x2: -3, z2: -12 },
    { x1: 3, z1: 12, x2: 12, z2: 16 },
    { x1: 11, z1: -11, x2: 17, z2: -4 },
    { x1: -17, z1: 4, x2: -11, z2: 11 },
  ],
  ROCKS: [
    { x: 0, z: -26, r: 2.6 }, { x: 0, z: 26, r: 2.6 },
    { x: -24, z: -22, r: 2.0 }, { x: 24, z: 22, r: 2.0 },
  ],
  BUSHES: [
  ...
  WOLF_CAMPS: [],
  DRAGON_PIT: { x: 0, z: 80 }, // 사용 안 함 — 벽 밖
  BARON_PIT: { x: 0, z: -80 },
}

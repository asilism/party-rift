...
export default function Rift3D({ sample, myId, mode = '3v3', hitFx = true, gfx = 'med', camZoom = 1 }) {
  ...
  useEffect(() => {
    ...
    scene.setCamZoom?.(camZoomRef.current)
  ...
  useEffect(() => {
    sceneRef.current?.setCamZoom?.(camZoom)
  }, [camZoom])

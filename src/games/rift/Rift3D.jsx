...
export default function Rift3D({ sample, myId, mode = '3v3', hitFx = true, gfx = 'med', arenaLayout = null }) {
  ...
  useEffect(() => {
    ...
    const scene = createRiftScene(canvas, buildMap(mode, arenaLayout), gfx)

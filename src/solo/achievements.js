...
export const ACHIEVEMENTS = [
  ...
  // ── 난투전 ──
  { id: 'brawl_first_win', icon: '💥', name: '난투 챔피언', desc: '난투전 첫 우승', get: (c) => c.brawlWins || 0, target: 1, reward: 100 },
  { id: 'brawl_wins_10', icon: '💥', name: '단상의 상습범', desc: '난투전 우승 10회', get: (c) => c.brawlWins || 0, target: 10, reward: 250, title: '난투왕' },
  { id: 'brawl_top3_10', icon: '🏅', name: '포디움 단골', desc: '난투전 3위 이내 10회', get: (c) => c.brawlTop3 || 0, target: 10, reward: 120 },
  { id: 'brawl_games_30', icon: '🥊', name: '난투 중독', desc: '난투전 30판 출전', get: (c) => c.brawlGames || 0, target: 30, reward: 100 },
